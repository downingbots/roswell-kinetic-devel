...
#ifndef ROSWELL_FAKE_H_
#define ROSWELL_FAKE_H_
...
#include "roswell_fake.h"

/* turtlebot3 values NOT USED BY ORIGINAL PLUGIN!
...
/* ARD: modified plugin to use */
#define VELOCITY_STEP                   0.00001   // m/s
#define MAX_VELOCITY                    0.22   // m/s

#define WHEEL_RADIUS                    0.06191     // meter
